...
class TokenServiceServicer(object):
    ...
    def rejectToken(self, request, context):
        ...
        account to the treasury for each tokens. This transfer SHALL NOT charge any custom fee or
        ...
        of 0 for the rejected tokens. The treasury balance SHALL increase by the amount that
